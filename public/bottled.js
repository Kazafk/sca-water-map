...
const RAW = [
  ...
  { id:'cristaline', nom:'Cristaline', pays:'France', ville_origine:'Sources multiples (ex. Sainte Cécile)', entreprise:'Sources Alma', type_eau:'Plate', categorie:'Source', ph:7.5, tds_mg_l:250, calcium_mg_l:39.0, magnesium_mg_l:2.5, sodium_mg_l:4.5, potassium_mg_l:1.5, bicarbonate_mg_l:120.0, sulfate_mg_l:18.0, chlorure_mg_l:8.0, silice_mg_l:5.0, nitrate_mg_l:2.0, description:"Eau de source de qualité, embouteillée directement sur plus de 30 sources différentes en France. Composition moyenne." },
